...
#define F_SIGNAL 25 // Frequency of output analog signal
/* USER CODE END PD */
...
uint32_t previous_time = 0; // Previous time
uint32_t current_time = 0; // Current time
char waveform[3][12] = {"Sine", "Triangular", "Sawtooth"}; // Current waveform
uint32_t waveform_index = 0; // Current waveform index
...
316,339,363,387,412,436,461,486,512,
};
...
int main(void)
{
  ...
  lcd_command(CLEAR);
  lcd_putstring(waveform[waveform_index]);
